...
package com.AT.base.sfData.objectDescribe.describeLayoutPOJO;
...
@JsonPropertyOrder({ "aggregatable", "aiPredictionField", "autoNumber", "byteLength", "calculated", "calculatedFormula",
		"cascadeDelete", "caseSensitive", "compoundFieldName", "controllerName", "createable", "custom", "defaultValue",
		"defaultValueFormula", "defaultedOnCreate", "dependentPicklist", "deprecatedAndHidden", "digits",
		"displayLocationInDecimal", "encrypted", "externalId", "extraTypeInfo", "filterable", "filteredLookupInfo",
		"formulaTreatNullNumberAsZero", "groupable", "highScaleNumber", "htmlFormatted", "idLookup", "inlineHelpText",
		"label", "length", "mask", "maskType", "name", "nameField", "namePointing", "nillable", "permissionable",
		"picklistValues", "polymorphicForeignKey", "precision", "queryByDistance", "referenceTargetField",
		"referenceTo", "relationshipName", "relationshipOrder", "restrictedDelete", "restrictedPicklist", "scale",
		"searchPrefilterable", "soapType", "sortable", "type", "unique", "updateable", "writeRequiresMasterRead" })
public class Details {
	...
	public int hashCode() {
		...
		result = ((result * 31)
				+ ((this.writeRequiresMasterRead == null) ? 0 : this.writeRequiresMasterRead.hashCode()));
		...
		result = ((result * 31)
				+ ((this.displayLocationInDecimal == null) ? 0 : this.displayLocationInDecimal.hashCode()));
		...
		result = ((result * 31)
				+ ((this.formulaTreatNullNumberAsZero == null) ? 0 : this.formulaTreatNullNumberAsZero.hashCode()));
		return result;
	}
	...
	public boolean equals(Object other) {
		...
		return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((this.defaultValue == rhs.defaultValue)
				|| ((this.defaultValue != null) && this.defaultValue.equals(rhs.defaultValue)))
				&& ((this.precision == rhs.precision)
						|| ((this.precision != null) && this.precision.equals(rhs.precision))))
				&& ((this.compoundFieldName == rhs.compoundFieldName)
						|| ((this.compoundFieldName != null) && this.compoundFieldName.equals(rhs.compoundFieldName))))
				&& ((this.nameField == rhs.nameField)
						|| ((this.nameField != null) && this.nameField.equals(rhs.nameField))))
				...
				&& ((this.relationshipName == rhs.relationshipName)
						|| ((this.relationshipName != null) && this.relationshipName.equals(rhs.relationshipName))))
				&& ((this.calculatedFormula == rhs.calculatedFormula)
						|| ((this.calculatedFormula != null) && this.calculatedFormula.equals(rhs.calculatedFormula))))
				&& ((this.controllerName == rhs.controllerName)
						|| ((this.controllerName != null) && this.controllerName.equals(rhs.controllerName))))
				&& ((this.namePointing == rhs.namePointing)
						|| ((this.namePointing != null) && this.namePointing.equals(rhs.namePointing))))
				&& ((this.defaultValueFormula == rhs.defaultValueFormula) || ((this.defaultValueFormula != null)
						&& this.defaultValueFormula.equals(rhs.defaultValueFormula))))
				&& ((this.calculated == rhs.calculated)
						|| ((this.calculated != null) && this.calculated.equals(rhs.calculated))))
				&& ((this.writeRequiresMasterRead == rhs.writeRequiresMasterRead)
						|| ((this.writeRequiresMasterRead != null)
								&& this.writeRequiresMasterRead.equals(rhs.writeRequiresMasterRead))))
				&& ((this.inlineHelpText == rhs.inlineHelpText)
						|| ((this.inlineHelpText != null) && this.inlineHelpText.equals(rhs.inlineHelpText))))
				&& ((this.picklistValues == rhs.picklistValues)
						|| ((this.picklistValues != null) && this.picklistValues.equals(rhs.picklistValues))))
				&& ((this.aiPredictionField == rhs.aiPredictionField)
						|| ((this.aiPredictionField != null) && this.aiPredictionField.equals(rhs.aiPredictionField))))
				&& ((this.filterable == rhs.filterable)
						|| ((this.filterable != null) && this.filterable.equals(rhs.filterable))))
				&& ((this.maskType == rhs.maskType) || ((this.maskType != null) && this.maskType.equals(rhs.maskType))))
				&& ((this.queryByDistance == rhs.queryByDistance)
						|| ((this.queryByDistance != null) && this.queryByDistance.equals(rhs.queryByDistance))))
				&& ((this.caseSensitive == rhs.caseSensitive)
						|| ((this.caseSensitive != null) && this.caseSensitive.equals(rhs.caseSensitive))))
				&& ((this.aggregatable == rhs.aggregatable)
						|| ((this.aggregatable != null) && this.aggregatable.equals(rhs.aggregatable))))
				&& ((this.referenceTo == rhs.referenceTo)
						|| ((this.referenceTo != null) && this.referenceTo.equals(rhs.referenceTo))))
				&& ((this.soapType == rhs.soapType) || ((this.soapType != null) && this.soapType.equals(rhs.soapType))))
				&& ((this.unique == rhs.unique) || ((this.unique != null) && this.unique.equals(rhs.unique))))
				&& ((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name))))
				&& ((this.highScaleNumber == rhs.highScaleNumber)
						|| ((this.highScaleNumber != null) && this.highScaleNumber.equals(rhs.highScaleNumber))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.idLookup == rhs.idLookup) || ((this.idLookup != null) && this.idLookup.equals(rhs.idLookup))))
				&& ((this.displayLocationInDecimal == rhs.displayLocationInDecimal)
						|| ((this.displayLocationInDecimal != null)
								&& this.displayLocationInDecimal.equals(rhs.displayLocationInDecimal))))
				&& ((this.defaultedOnCreate == rhs.defaultedOnCreate)
						|| ((this.defaultedOnCreate != null) && this.defaultedOnCreate.equals(rhs.defaultedOnCreate))))
				&& ((this.updateable == rhs.updateable)
						|| ((this.updateable != null) && this.updateable.equals(rhs.updateable))))
				&& ((this.deprecatedAndHidden == rhs.deprecatedAndHidden) || ((this.deprecatedAndHidden != null)
						&& this.deprecatedAndHidden.equals(rhs.deprecatedAndHidden))))
				&& ((this.byteLength == rhs.byteLength)
						|| ((this.byteLength != null) && this.byteLength.equals(rhs.byteLength))))
				&& ((this.scale == rhs.scale) || ((this.scale != null) && this.scale.equals(rhs.scale))))
				&& ((this.polymorphicForeignKey == rhs.polymorphicForeignKey) || ((this.polymorphicForeignKey != null)
						&& this.polymorphicForeignKey.equals(rhs.polymorphicForeignKey))))
				&& ((this.nillable == rhs.nillable) || ((this.nillable != null) && this.nillable.equals(rhs.nillable))))
				&& ((this.htmlFormatted == rhs.htmlFormatted)
						|| ((this.htmlFormatted != null) && this.htmlFormatted.equals(rhs.htmlFormatted))))
				&& ((this.referenceTargetField == rhs.referenceTargetField) || ((this.referenceTargetField != null)
						&& this.referenceTargetField.equals(rhs.referenceTargetField))))
				&& ((this.cascadeDelete == rhs.cascadeDelete)
						|| ((this.cascadeDelete != null) && this.cascadeDelete.equals(rhs.cascadeDelete))))
				&& ((this.mask == rhs.mask) || ((this.mask != null) && this.mask.equals(rhs.mask))))
				&& ((this.permissionable == rhs.permissionable)
						|| ((this.permissionable != null) && this.permissionable.equals(rhs.permissionable))))
				&& ((this.relationshipOrder == rhs.relationshipOrder)
						|| ((this.relationshipOrder != null) && this.relationshipOrder.equals(rhs.relationshipOrder))))
				&& ((this.custom == rhs.custom) || ((this.custom != null) && this.custom.equals(rhs.custom))))
				&& ((this.length == rhs.length) || ((this.length != null) && this.length.equals(rhs.length))))
				&& ((this.externalId == rhs.externalId)
						|| ((this.externalId != null) && this.externalId.equals(rhs.externalId))))
				&& ((this.dependentPicklist == rhs.dependentPicklist)
						|| ((this.dependentPicklist != null) && this.dependentPicklist.equals(rhs.dependentPicklist))))
				&& ((this.label == rhs.label) || ((this.label != null) && this.label.equals(rhs.label))))
				&& ((this.sortable == rhs.sortable) || ((this.sortable != null) && this.sortable.equals(rhs.sortable))))
				&& ((this.autoNumber == rhs.autoNumber)
						|| ((this.autoNumber != null) && this.autoNumber.equals(rhs.autoNumber))))
				&& ((this.filteredLookupInfo == rhs.filteredLookupInfo) || ((this.filteredLookupInfo != null)
						&& this.filteredLookupInfo.equals(rhs.filteredLookupInfo))))
				&& ((this.restrictedPicklist == rhs.restrictedPicklist) || ((this.restrictedPicklist != null)
						&& this.restrictedPicklist.equals(rhs.restrictedPicklist))))
				&& ((this.createable == rhs.createable)
						|| ((this.createable != null) && this.createable.equals(rhs.createable))))
				&& ((this.encrypted == rhs.encrypted)
						|| ((this.encrypted != null) && this.encrypted.equals(rhs.encrypted))))
				&& ((this.searchPrefilterable == rhs.searchPrefilterable) || ((this.searchPrefilterable != null)
						&& this.searchPrefilterable.equals(rhs.searchPrefilterable))))
				&& ((this.extraTypeInfo == rhs.extraTypeInfo)
						|| ((this.extraTypeInfo != null) && this.extraTypeInfo.equals(rhs.extraTypeInfo))))
				&& ((this.groupable == rhs.groupable)
						|| ((this.groupable != null) && this.groupable.equals(rhs.groupable))))
				&& ((this.digits == rhs.digits) || ((this.digits != null) && this.digits.equals(rhs.digits))))
				&& ((this.formulaTreatNullNumberAsZero == rhs.formulaTreatNullNumberAsZero)
						|| ((this.formulaTreatNullNumberAsZero != null)
								&& this.formulaTreatNullNumberAsZero.equals(rhs.formulaTreatNullNumberAsZero))));
	}
